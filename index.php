...
function render_sidebar(): void {
  ...
  ?><aside class="sidebar p-3">
    ...
    if ($objectsBeforeDb) {
      ...
      if ($dbName !== '') echo '<hr class="ms-sidebar-section-divider">';
    }
    ?>
    ...
    <?php if (!$objectsBeforeDb && $dbName !== '') { echo '<hr class="ms-sidebar-section-divider">'; $renderSidebarObjects(); } ?>
